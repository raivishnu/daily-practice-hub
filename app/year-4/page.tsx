...
export const metadata: Metadata = {
  title: 'Year 4 Practice Sheets',
  description: 'Free daily practice sheets for Year 4 students. Download Maths, English, and more.',
}
...
export default async function Year4Page({ searchParams }: PageProps) {
  const yearLevel = 4
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">Year 4 Practice Sheets</h1>
        <p className="text-muted-foreground text-lg">
          Download free daily practice sheets for Year 4 students
        </p>
      </div>
